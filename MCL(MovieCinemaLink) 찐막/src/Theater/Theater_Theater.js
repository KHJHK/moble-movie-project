        ...
        <div className="theater">
          <div className="TempPurbg">
            <div className="TempPur_explanation">
              <h2>템퍼시네마</h2>
              <p>
                NASA(미 항공 우주국)의 신소재로 유명한 프리미엄 매트리스&베개
                브랜드 '템퍼'와의 콜라보레이션으로 탄생한 세계 최초 리클라이닝
                침대 영화관 입니다.
              </p>
            </div>
          ...
          <div className="sphereXbg">
            <div className="sphereX_explanation">
              ...
              <p>
                ...
                특별관입니다. 스크린, 사운드, 좌석이 만들어내는 최대 시너지로
                ‘나를 감싸는 극강의 몰입감’을 즐길 수 있습니다.
              </p>
            </div>
          ...
          <div className="IMAXbg">
            <div className="IMAX_explanation">
              <h2>IMAX시네마</h2>
              <p>
                IMAX는 궁극의 몰입감으로 불리는 영화관으로 대형 스크린에 맞는
                맞춤형 설계로 모든 좌석에서 최고의 몰입감을 느낄 수 있고 핀
                포인트 정확도로 최적의 사운드를 제공받을 수 있습니다.
              </p>
            </div>
          ...
          <div className="fourDXbg">
            <div className="fourDX_explanation">
              <h2>4DX시네마</h2>
              <p>
                4DX 상영관은 영화의 장면에 맞추어 움직이는 모션시트와 더불어
                바람, 빛, 안개, 향기, 진동 등의 다양한 환경 효과를 느낄 수 있는
                오감 체험 특별 상영관입니다.
              </p>
            </div>

            <div className="fourDX">
              <img src="./img/fourDX.gif"></img>
            </div>
          </div>
        </div>
      </div>
