      ...
      <div className="Ticketcenter">
        <div className="Reservation_information">
          <div className="Reservation_picter">
            ...
            <img src={IMG_BASE_URL + movieporster} alt="점검상태입니다" id="Reervation_picter" />
          </div>

          <div className="profilename">
          <p>영화선택 : {moviecheck} </p><br/>
              <p>선택지역 : {movieRegion} </p><br/>
              <p>극장위치 : {movieCinema} </p><br/>
              <p>상영날짜 : {movieDate} </p><br/>
              <p>상영시간 : {movieTime} </p><br/>
              <p>예매좌석 : {movieSeat} </p>
            <br />
